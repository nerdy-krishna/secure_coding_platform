...
const UserManagementTab: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (isSuper: boolean) =>
        isSuper ? <Text type="warning"> Yes </Text> : <Text>No</Text>,
    },
    {
      title: "Verified",
      dataIndex: "is_verified",
      key: "is_verified",
      render: (isVer: boolean) =>
        isVer ? (
          <Text type="success"> Yes </Text>
        ) : (
  ...
  const handleCreateUser = async (values: any) => {
    ...
    try {
      ...
      message.success(
        "User created successfully. A setup email has been sent.",
      );
      setIsModalVisible(false);
      fetchUsers();
    } catch (error) {
  ...
  return (
    <div>
      ...
      <Paragraph>
        {" "}
        Manage user accounts, assign superuser roles, and monitor account
        verification status.
      </Paragraph>
      <div
        style={{
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            tooltip="Check this if the user doesn't need to verify their email."
          >
