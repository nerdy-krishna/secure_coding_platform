...
try:
    ...
    log.info(f"Alembic configured with database URL for host: {settings.POSTGRES_HOST_ALEMBIC}")

    target_metadata = Base.metadata
    log.info(f"Tables discovered in Base.metadata: {list(target_metadata.tables.keys())}")
