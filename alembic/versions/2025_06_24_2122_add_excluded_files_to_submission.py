"""add_excluded_files_to_submission

Revision ID: 6e3a055e82dd
Revises: bbe5b1b68796
Create Date: 2025-06-24 21:22:29.926334
...
revision: str = '6e3a055e82dd'
down_revision: Union[str, None] = 'bbe5b1b68796'
...
def upgrade() -> None:
    ...
    op.add_column('code_submissions', sa.Column('excluded_files', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='A list of file paths to exclude from the analysis.'))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('code_submissions', 'excluded_files')
