...
Revision ID: 016969003384
Revises: 
Create Date: 2025-06-14 15:45:12.249879
...
from sqlalchemy.dialects.postgresql import UUID # Explicitly import UUID for robust type definition


# revision identifiers, used by Alembic.
revision: str = '016969003384'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_llm_configurations_name'), 'llm_configurations', ['name'], unique=True)
    op.create_table('user',
    sa.Column('id', UUID(), nullable=False), # Changed from fastapi_users_db_sqlalchemy.generics.GUID()
    ...
    sa.Column('id', UUID(), nullable=False),
    sa.Column('user_id', UUID(), nullable=False), # Changed from fastapi_users_db_sqlalchemy.generics.GUID()
    sa.Column('repo_url', sa.String(), nullable=True),
    sa.Column('status', sa.String(), nullable=False),
    sa.Column('submitted_at', sa.DateTime(), nullable=False),
    sa.Column('completed_at', sa.DateTime(), nullable=True),
    sa.Column('frameworks', sa.JSON(), nullable=True),
    sa.Column('main_llm_config_id', UUID(), nullable=True),
    sa.Column('specialized_llm_config_id', UUID(), nullable=True),
    sa.ForeignKeyConstraint(['main_llm_config_id'], ['llm_configurations.id'], ),
    sa.ForeignKeyConstraint(['specialized_llm_config_id'], ['llm_configurations.id'], ),
