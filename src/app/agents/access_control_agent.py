...
AGENT_DOMAIN_QUERY = "access control, authorization, user permissions, roles, insecure direct object reference (IDOR), privileges"
...
async def assess_vulnerabilities_node(state: SpecializedAgentState) -> Dict[str, Any]:
    ...
    Identify vulnerabilities and respond with a structured list of findings.
    """
    ...
    # Ensure parsed_output is not None before trying to call .dict()
