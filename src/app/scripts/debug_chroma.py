...
def run_test():
    ...
    try:
        ...
        logging.info(
            f"Server heartbeat successful. Nanoseconds since epoch: {heartbeat}"
        )
        ...
        logging.info(
            f"Successfully got collection '{collection.name}'. Count: {collection.count()}"
        )
        ...
        print("\n" + "=" * 50)
        print(
            "✅ SUCCESS: All connection and data retrieval steps completed successfully!"
        )
        print("=" * 50)
