# src/app/infrastructure/agents/architecture_agent.py
import logging
...
AGENT_PROMPT_NAME = "Security Architecture and Design"
AGENT_DOMAIN_QUERY = "security architecture, design patterns, data flow, trust boundaries, tiering, segregation, component separation, security principles, microservices security"
