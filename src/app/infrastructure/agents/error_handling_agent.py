# src/app/infrastructure/agents/error_handling_agent.py
...
AGENT_PROMPT_NAME = "Error Handling and Information Leakage"
AGENT_DOMAIN_QUERY = "error handling, information leakage, stack traces, verbose error messages, debugging information exposure, exception handling, logging sensitive information"
