...
AGENT_PROMPT_NAME = "Session Management"
AGENT_DOMAIN_QUERY = "session management, session fixation, session hijacking, cookie security, insecure session tokens, session timeout, CSRF, cross-site request forgery, JWT session tokens"
