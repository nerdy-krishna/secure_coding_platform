# src/app/infrastructure/agents/code_integrity_agent.py
...
AGENT_PROMPT_NAME = "Code and Software Integrity"
AGENT_DOMAIN_QUERY = "software integrity, code signing, dependency security, supply chain attacks, insecure deserialization, code tampering, third-party libraries, SCA, software composition analysis"
