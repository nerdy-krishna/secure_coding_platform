# src/app/infrastructure/agents/validation_agent.py
...
AGENT_PROMPT_NAME = "Input Validation and Output Encoding"
AGENT_DOMAIN_QUERY = "input validation, output encoding, SQL injection (SQLi), Cross-Site Scripting (XSS), command injection, type validation, sanitization, denylisting, allowlisting, parameter tampering"
