# src/app/infrastructure/agents/business_logic_agent.py
...
AGENT_PROMPT_NAME = "Business Logic Security"
AGENT_DOMAIN_QUERY = "business logic vulnerabilities, workflow abuse, race conditions, unexpected application state, feature misuse, price manipulation, excessive computation"
