# src/app/infrastructure/agents/authentication_agent.py
...
AGENT_PROMPT_NAME = "Authentication and Credential Management"
AGENT_DOMAIN_QUERY = "authentication, login, password policies, credential management, multi-factor authentication (MFA), single sign-on (SSO), password hashing, forgot password, remember me"
