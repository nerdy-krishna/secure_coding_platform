# src/app/infrastructure/agents/file_handling_agent.py
...
AGENT_PROMPT_NAME = "Secure File Handling"
AGENT_DOMAIN_QUERY = "file handling, file upload vulnerabilities, path traversal, directory traversal, unrestricted file upload, malware upload, remote file inclusion (RFI), local file inclusion (LFI)"
