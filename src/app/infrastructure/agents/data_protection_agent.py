# src/app/infrastructure/agents/data_protection_agent.py
...
AGENT_PROMPT_NAME = "Data Protection"
AGENT_DOMAIN_QUERY = "data protection, sensitive data exposure, PII, personally identifiable information, data at rest, data classification, data masking, tokenization, GDPR, CCPA"
