# src/app/infrastructure/agents/configuration_agent.py
...
AGENT_PROMPT_NAME = "Secure Configuration"
AGENT_DOMAIN_QUERY = "security misconfiguration, default credentials, verbose error messages, unnecessary features, improper server hardening, security headers, file permissions"
